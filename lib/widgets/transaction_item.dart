  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Text(transactionModel.amount, style: AppStyles.styleSemiBold20(context).copyWith( color: transactionModel.isWithDrawal ? Color(0xFFF3735E) : Color(0xFF7DD97B)),),
      ),
    );
  }
}